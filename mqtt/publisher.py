...
try:
    while True: 
        ...
        client.publish('python/CA171/mqtt', 'Feriana Lestari')
        client.publish('python/CA171/name', 'Feriana (170010236)')
        client.publish('python/CA171/email', 'FerianaLestari')
        client.publish('python/CA171/name', 'FerianaLestari')
